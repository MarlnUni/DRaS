...
const availableCourses = [
  { id: 1, name: 'DRaS: Data Science', price: 200 },
  { id: 2, name: 'DRaS: AI Fundamentals', price: 250 },
  { id: 3, name: 'DRaS: Cloud Computing', price: 180 },
  { id: 4, name: 'DRaS: Cybersecurity', price: 220 },
];

const mockActive = [
  { id: 1, name: 'DRaS: Data Science', expires: '2025-12-31' },
  { id: 2, name: 'DRaS: AI Fundamentals', expires: '2025-09-30' },
];

const mockBills = [
  { id: 1, due: '2025-07-15', amount: 400, desc: 'Quarterly DRaS Subscription' },
];
  ...
  return (
    <div className="flex h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <div className="flex-1 overflow-auto">
        <div className="p-6">
          <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-6">System Settings & DRaS Integration</h1>

          {/* Available Courses */}
          <div className="mb-8">
            <div className="flex justify-between items-center mb-2">
              <h2 className="text-xl font-semibold text-gray-700 dark:text-gray-200 flex items-center gap-2"><BookOpen size={20}/> Available DRaS Courses</h2>
              <button
          ...
          <div className="mb-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
              {activeCourses.length === 0 ? (
                <div className="text-gray-500 dark:text-gray-400">No active DRaS courses.</div>
              ) : (
          ...
          {/* Upcoming Bills */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-gray-700 dark:text-gray-200 mb-2 flex items-center gap-2"><CreditCard size={20}/> Upcoming DRaS Bills</h2>
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
              {bills.length === 0 ? (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-lg">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100">Purchase DRaS Courses</h2>
