...
const mockCourses = [
  ...
  { id: 2, name: 'DRaS: Data Science', completions: 90, enrollments: 100, type: 'dras' },
  { id: 3, name: 'Calculus I', completions: 80, enrollments: 110, type: 'university' },
  { id: 4, name: 'DRaS: AI Fundamentals', completions: 60, enrollments: 70, type: 'dras' },
...
export default function Reports() {
  ...
  const drasCourses = filteredCourses.filter(c => c.type === 'dras');
  const drasPerformance = drasCourses.reduce((sum, c) => sum + c.completions, 0);
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 flex items-center gap-4">
              ...
              <div>
                <div className="text-lg font-semibold text-gray-700 dark:text-gray-200 flex items-center gap-2">
                  DRaS Performance
                  <span className="bg-purple-100 dark:bg-purple-900 text-purple-700 dark:text-purple-300 px-2 py-0.5 rounded text-xs font-semibold ml-2">DRaS</span>
                </div>
                <div className="text-2xl font-bold text-purple-700 dark:text-purple-400">{drasPerformance}</div>
              </div>
            </div>
          </div>
