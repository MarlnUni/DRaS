...
const courses = [
  { id: 1, code: 'AI401', name: 'Artificial Intelligence for Defence Applications' },
  { id: 2, code: 'AP402', name: 'Autonomous Platforms in Defence Applications' },
];
...
const assignments = [
  ...
  {
    id: 3,
    title: 'Computer Vision in Defence Applications',
    course: 'AI401',
    dueDate: '2024-03-15',
    submissions: 40,
    totalStudents: 42,
